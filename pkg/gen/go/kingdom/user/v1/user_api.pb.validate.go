...
func (m *DeleteRequest) Validate() error {
	...
	if !_DeleteRequest_RealmId_Pattern.MatchString(m.GetRealmId()) {
		return DeleteRequestValidationError{
			field:  "RealmId",
			reason: "value does not match regex pattern \"^[0-9A-Za-z]+$\"",
		}
	...
	if !_DeleteRequest_UserId_Pattern.MatchString(m.GetUserId()) {
		return DeleteRequestValidationError{
			field:  "UserId",
			reason: "value does not match regex pattern \"^[0-9A-Za-z]+$\"",
		}
...
var _DeleteRequest_RealmId_Pattern = regexp.MustCompile("^[0-9A-Za-z]+$")

var _DeleteRequest_UserId_Pattern = regexp.MustCompile("^[0-9A-Za-z]+$")
