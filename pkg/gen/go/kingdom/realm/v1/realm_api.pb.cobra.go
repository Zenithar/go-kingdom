...
var RealmAPIClientCommand = &cobra.Command{
	Use: "realmAPI",
}

var realmAPI_CreateClientCommand = &cobra.Command{
	Use:  "create",
...
func init() {
	RealmAPIClientCommand.AddCommand(realmAPI_CreateClientCommand)
	DefaultClientCommandConfig.AddFlags(realmAPI_CreateClientCommand.Flags())
}

var realmAPI_GetClientCommand = &cobra.Command{
	Use:  "get",
	Long: "Get client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	RealmAPIClientCommand.AddCommand(realmAPI_GetClientCommand)
	DefaultClientCommandConfig.AddFlags(realmAPI_GetClientCommand.Flags())
}

var realmAPI_UpdateClientCommand = &cobra.Command{
	Use:  "update",
	Long: "Update client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
...
func init() {
	RealmAPIClientCommand.AddCommand(realmAPI_UpdateClientCommand)
	DefaultClientCommandConfig.AddFlags(realmAPI_UpdateClientCommand.Flags())
}

var realmAPI_DeleteClientCommand = &cobra.Command{
	Use:  "delete",
	Long: "Delete client\n\nYou can use environment variables with the same name of the command flags.\nAll caps and s/-/_, e.g. SERVER_ADDR.",
	Example: `
Save a sample request to a file (or refer to your protobuf descriptor to create one):
