...
var fileDescriptor_b70e813c2f6610d1 = []byte{
	...
	,
}
...
func (m *User) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Principal) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintUser(dAtA, i, uint64(len(m.Principal)))
...
func NewPopulatedUser(r randyUser, easy bool) *User {
	...
	this.Principal = string(randStringUser(r))
	if !easy && r.Intn(10) != 0 {
